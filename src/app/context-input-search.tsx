...
function ProcesoRow ( { proceso }: { proceso: intProceso; } ) {
    const name = proceso.sujetosProcesales.slice( 0, 10 ).toLocaleLowerCase();
    ...
    return (
        <Card
            ...
            title={ proceso.sujetosProcesales.toLowerCase().split( ' ' )[ 0 ] + ' ' + proceso.sujetosProcesales.toLowerCase().split( ' ' )[ 2 ] }
